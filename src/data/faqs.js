 ...
 * --------------------------
 * The questions and answers on /frequently-asked-questions/.
 *
 * ---------------------------------------------------------------------
 * THE RULE THAT GOVERNS EVERY ANSWER
 * ---------------------------------------------------------------------
 * Nothing here is legal advice, and nothing here may be written as
 * though it were. An answer explains how something generally works and
 * what a person would need to establish; it never tells a reader what
 * to do in their own matter, never predicts an outcome, and never
 * assumes facts the reader has not given.
 *
 * The same content restrictions apply as to the guides. No answer may
 * state a decided case, a citation, a government fee, a stamp duty rate,
 * a tax rate, a limitation period, a deadline, a processing time, or how
 * a government portal behaves. A provision may be named; the period it
 * prescribes may be described but never numbered.
 *
 * Where an answer could be read as applying a rule to a reader's
 * situation, it says instead what the position depends on and that it
 * should be confirmed on the documents.
 *
  ...
  categories: [
    {
      slug: "consultations",
      name: "Consultations",
      lead: "How a first discussion works and what to bring to it.",
      items: [
        [
        ...
        [
          "Can a matter be discussed by telephone or video?",
...

    {
      slug: "civil-matters",
      name: "Civil matters",
      lead: "Suits, defences, interim relief and execution.",
      items: [
        [
          "What kinds of civil matter does the firm attend to?",
        ...
        [
          "Can a matter be settled instead of litigated?",
...

    {
      ...
      lead: "Complaints, bail, investigation and trial.",
      items: [
        [
          "What criminal work does the firm attend to?",
        ...
        [
          "An FIR has been registered. What happens next?",
        ...
        [
          "Which law applies — the new codes or the older ones?",
        ...
        [
          "Can a criminal case be withdrawn or compromised?",
        ...
        [
          "I have been asked to attend for questioning. Should I?",
...

    {
      slug: "cheque-bounce",
      name: "Cheque bounce",
      lead: "Dishonoured cheques, demand notices and recovery.",
      items: [
        [
          "My cheque has been returned unpaid. What is the first thing to do?",
        ...
        [
          "Is there a criminal remedy as well as a civil one?",
        ...
        [
          "Can I deposit the cheque again?",
        ...
        [
          "I have received a cheque-bounce notice. What are my options?",
        ...
        [
          "Which court hears a cheque-bounce complaint?",
...

    {
      slug: "property",
      name: "Property",
      lead: "Title, registration, mutation and property disputes.",
      items: [
        [
        ...
        [
          "How much stamp duty and registration fee will be payable?",
        ...
        [
          "The property is in my father's name and he has died. What do I do?",
...

    {
      slug: "agreements",
      name: "Agreements",
      lead: "Contracts, deeds and the documents a business uses.",
      items: [
        [
        ...
        [
          "Does an agreement have to be on stamp paper to be valid?",
        ...
        [
          "Do I need a written contract if I trust the other side?",
        ...
        [
          "What is the most important clause in a commercial agreement?",
        ...
        [
          "Can a contract be enforced if the other side has not signed it?",
        ...
        [
          "Should I use a template found online?",
...

    {
      slug: "tax-and-gst",
      name: "Tax and GST",
      lead: "Notices, assessments, returns and registration.",
      items: [
        [
          "I have received a tax notice. What should I do first?",
        ...
        [
          "Is my business required to register under GST?",
        ...
        [
          "What happens if I do not reply to a notice?",
        ...
        [
          "Can an advocate appear before tax authorities?",
        ...
        [
          "How long will an assessment or appeal take?",
...

    {
      ...
      lead: "Choosing a structure and registering an entity.",
      items: [
        [
          "Which structure should I choose for my business?",
        ...
        [
          "Do I need a partnership deed if there are only two of us?",
        ...
        [
          "Will someone from the firm certify my accounts?",
...

    {
      ...
      name: "Uttar Pradesh service coverage",
      lead: "Where the firm is based and how matters elsewhere in the state are handled.",
      items: [
        [
        ...
        [
          "Can you act in a matter outside Lucknow?",
        ...
        [
          "Can a matter be handled without my travelling to Lucknow?",
        ...
        [
          "Do you take matters outside Uttar Pradesh?",
        ...
        [
          "Which advocate will deal with my matter?",
